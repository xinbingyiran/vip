...
(function () {
    ...
    function PanHelper() {
        ...
        function checkboxClick(e) {
            ...
            if ($parent.hasClass(wordMap['JS-item-active'])) {
        ...
        function registerCheckbox() {
            ...
            $checkbox.each(function (index, element) {
                $(element).bind('click', checkboxClick);
            });
        }
        ...
        function unregisterCheckbox() {
            ...
            var $checkbox = $('span.' + wordMap['checkbox']);
            $checkbox.each(function (index, element) {
                $(element).unbind('click', checkboxClick);
            });
        }

        function allCheckboxClick(e) {
            var $parent = $(this).parent();
        ...
        function registerAllCheckbox() {
            ...
            $checkbox.each(function (index, element) {
                $(element).bind('click', allCheckboxClick);
            });
        }
        ...
        function unregisterAllCheckbox() {
            ...
            var $checkbox = $('div.' + wordMap['col-item'] + '.' + wordMap['check']);
            $checkbox.each(function (index, element) {
                $(element).unbind('click', allCheckboxClick);
            });
        }
        ...
        function fileSelect(e) {
            ...
            if (nodeName != 'span' && nodeName != 'a' && nodeName != 'em') {
                ...
                if (!e.shiftKey) {
                    ...
                    var $dd_select = $('div.' + wordMap['list-view'] + ' dd.' + wordMap['JS-item-active']);
        ...
        function unregisterFileSelect() {
            ...
            var $dd = $('div.' + wordMap['list-view'] + ' dd');
            $dd.each(function (index, element) {
                $(element).unbind('click',fileSelect);
            });
        }
